...
// Public-site source certification gate. Live clean-route behavior is verified separately after deployment.
const root = process.cwd();
const required = ['index.html','privacy.html','terms.html','support.html','security.html','styles.css'];
